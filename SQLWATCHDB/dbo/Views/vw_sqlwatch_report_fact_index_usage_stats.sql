...
, pbi_sqlwatch_index_id = us.sql_instance + '.DB.' + convert(varchar(10),us.sqlwatch_database_id) + '.TBL.' + convert(varchar(10),us.[sqlwatch_table_id]) +'.IDX.' + convert(varchar(10),us.sqlwatch_index_id)
