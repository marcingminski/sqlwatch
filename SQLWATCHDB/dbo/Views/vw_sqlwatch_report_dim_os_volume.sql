CREATE VIEW [dbo].[vw_sqlwatch_report_dim_os_volume] with schemabinding
	...
	with cte_volume as (
		select d.[sql_instance], d.[sqlwatch_volume_id], d.[volume_name], d.[label], d.[file_system], d.[volume_block_size_bytes], d.[date_created], d.[date_updated], d.[last_seen] 
	...
	select [sql_instance], [sqlwatch_volume_id], [volume_name], [label], [file_system], [volume_block_size_bytes], [date_created], [date_updated], [last_seen]
