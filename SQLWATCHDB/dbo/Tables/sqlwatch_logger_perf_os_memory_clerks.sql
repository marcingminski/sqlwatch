...
(
	...
	constraint fk_sql_perf_mon_os_memory_clerks_snapshot_header foreign key ([snapshot_time],[snapshot_type_id],[sql_instance]) 
	...
	constraint fk_sqlwatch_logger_perf_os_memory_clerks_server foreign key ([sql_instance])
