...
(
	...
	constraint [pk_sqlwatch_trend_perf_os_performance_counters] primary key ([snapshot_time] asc, [trend_interval_minutes],[sql_instance], [performance_counter_id] asc, [instance_name] asc),
