...
insert into #sql_perf_mon_config_perf_counters([collect],[object_name],[counter_name], [instance_name],[base_counter_name]) 
	values
		...
		,(1,'Database Replica','Log Bytes Received/sec','<* !_Total>',NULL)
		,(0,'Database Replica','Log remaining for undo','_Total',NULL)
		,(1,'Database Replica','Log Send Queue','<* !_Total>',NULL)
		...
		,(1,'Resource Pool Stats','CPU usage %','<* !_Total>','CPU usage % base ')
		,(1,'Resource Pool Stats','CPU usage % base','<* !_Total>',NULL)
