CREATE VIEW [dbo].[vw_sqlwatch_report_dim_master_file] with schemabinding
	AS 
		...
		left join (
				...
				from [dbo].[sqlwatch_logger_dm_io_virtual_file_stats]
		...
		left join [dbo].[sqlwatch_logger_dm_io_virtual_file_stats] fg
		...
		left join [dbo].[sqlwatch_logger_dm_io_virtual_file_stats] lg
